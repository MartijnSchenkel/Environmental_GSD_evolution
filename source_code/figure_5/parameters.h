...
constexpr int warmup_time = 5000; // Number of generations during which temperature increases
...
constexpr double survivalYY = 0.90; // proportion of YY individuals that survive

constexpr double dSAF = 0.5; // dominance of SA effect in females
constexpr double dSAM = 0.5; // dominance of SA effect in males
constexpr double sSAM = 0.03; // fitness effect of SA in males
...
constexpr double thresF = 1.15; // Threshold for F expression, higher => female. Below or above 1 (ALWAYS well below 2).
...
constexpr double muActivAM = 0.005; // Rate at which AM becomes expressed (de novo M-factor evolution)
...
constexpr double FE_diff = 1.4; // Fold difference in F expression between minimal and maximal temperature.
